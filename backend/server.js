...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:5000', 'http://3.145.137.229:5173', 'http://3.145.137.229:5000'],
...
// Serve static files from the React app if 'dist' folder exists
