...
const HRDashboard = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get(import.meta.env.VITE_BACKEND_URL + '/api/hrStudent'); // Use the correct endpoint
  ...
  const fetchCourses = async () => {
    try {
      const response = await axios.get(import.meta.env.VITE_BACKEND_URL + '/api/courses'); // Replace with your actual endpoint
