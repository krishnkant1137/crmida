...
const HRDashboard = () => {
  ...
  const fetchStudents = async () => {
    try {
      const response = await axios.get('frontend/vite.config.js/api/hrStudent'); // Use the correct endpoint
  ...
  const fetchCourses = async () => {
    try {
      const response = await axios.get('frontend/vite.config.js/api/courses'); // Replace with your actual endpoint
